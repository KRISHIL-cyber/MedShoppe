...
<body class="align">
  ...
  <div class="grid">
    ...
    <form id="form1" runat="server" class="form login">
      ...
      <div class="form__field">
        ...
        <%--<input id="login__password" type="password" name="password" class="form__input" placeholder="Password" required>--%>
          <asp:TextBox ID="TextBox2" runat="server" TextMode="Password" class="form__input" placeholder="Password" required="required"></asp:TextBox>
      </div>
    ...
    <p class="text--center">Not a member? <a href="/User/SignUp.aspx">Sign up now</a> <svg class="icon">
